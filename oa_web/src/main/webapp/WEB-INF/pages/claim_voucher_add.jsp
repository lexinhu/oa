                            ...
                            <div>
                                <div class="col-md-3">
                                    <label for="items[0].item" class="field prepend-icon">
                                        <form:select path="items[0].item" cssClass="gui-input" placeholder="花销类型..." items="${items}"/>                                    </label>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-5">
                                    <label for="items[0].comment" class="field prepend-icon">
                                        <form:input path="items[0].comment" class="gui-input" placeholder="备注..." type="text" value=""/>
